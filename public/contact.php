                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center no-gutters">
                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="#">mobil<i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                <li><a href="lexus.php">LEXUS</a></li>
                                                <li><a href="mazda.php">MAZDA</a></li>
                                            </ul>
                                        </li>
                        ...
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-img">
                                <a href="index.html">
                                    <img src="img/pintu koboi.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-xl-5 col-lg-4 d-none d-lg-block">
                            <div class="book_room">
                                ...
                                <div class="book_btn d-none d-lg-block">
                                    <a class="popup-with-form" href="#test-form">Book A Car</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
    ...
    <section class="contact-section">
            <div class="container">
                <div class="d-none d-sm-block mb-5 pb-4">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.7642995770893!2d106.9319041147729!3d-6.918757195000924!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e683633fcd15215%3A0x261f558445241e0c!2sUniversitas%20Muhammadiyah%20Sukabumi!5e0!3m2!1sid!2sid!4v1655352314806!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> 
                    ...
                    <script src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.7642995770893!2d106.9319041147729!3d-6.918757195000924!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e683633fcd15215%3A0x261f558445241e0c!2sUniversitas%20Muhammadiyah%20Sukabumi!5e0!3m2!1sid!2sid!4v1655352314806!5m2!1sid!2sid">
                    </script>
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>081290206650</h3>
                                <p>Monday - Saturday</p>
                                <p>8.00 am s/d 3.00 pm  </p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-email"></i></span>
                            <div class="media-body">
                                <h3>satriadhapa10@gmail.com</h3>
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <p class="footer_text" > Jl. R. Syamsudin, S.H. No. 50, Cikole, Kec. Cikole, <br>
                            Kota Sukabumi, Jawa Barat 43113</p>
                            <a href="https://www.google.com/search?gs_ssp=eJzj4tZP1zc0MsizMCwxNGD04k7MScxNLFEozc3NBABd6Ae4&q=alamat+ummi&rlz=1C1CHBD_enID990ID990&oq=alamat+umm&aqs=chrome.1.69i57j46i512j0i512l7.7342j0j7&sourceid=chrome&ie=UTF-8#" class="line-button">Get Direction</a>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <p class="footer_text" > 081290206650 <br>
                                    satriadhapa10@gmail.com</p>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6 col-lg-4">
                        <div class="footer_widget">
                            ...
                            <form action="https://support.google.com/mail/answer/56256?hl=id" class="newsletter_form">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-8 col-md-7 col-lg-9">
                        <p class="copy_right" align = 'center'>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved<i class="fa fa-heart-o" aria-hidden="true"></i> by Us
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <select class="form-select wide" id="default-select" class="">
                                    <option data-display="Type Mobil">SUV</option>
                                    <option value="1">Sedan</option>
                                    <option value="2">Truck</option>
                                    <option value="3">Family Car</option>
                                </select>
                            </div>
                            <div class="col-xl-6">
                                <select class="form-select wide" id="default-select" class="">
                                    <option data-display="Budget">Rp. 1.000.000 - Rp. 2.000.000</option>
                                    <option value="1">Rp. 2.000.000 - Rp. 4.000.000</option>
                                    <option value="2">Rp. 4.000.000 - Rp. 6.000.000</option>
                                    <option value="3">Rp. 6.000.000 - Rp. 8.000.000</option>
                                </select>
                            </div>
                            <div class="col-xl-12">
                                <select class="form-select wide" id="default-select" class="">
                                    <option data-display="Car Type">Car Type</option>
